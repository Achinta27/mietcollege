        ...
        <div className="lg:w-[60%] sm:w-full bg-white p-2 shadow-lg flex flex-col justify-between gap-4">
          ...
          <div className="flex flex-col md:flex-row gap-4 md:gap-8 md:justify-between">
            <Link
              ...
              target="_blank"
              className="text-[#DC143C] hover:bg-[#DC143C] hover:text-white border-2 border-[#DC143C] rounded text-lg md:text-base xlg:text-lg xl:text-2xl text-center font-bold py-[1.1vmax] sm:w-full md:w-[50%] px-[1.5vmax]"
            >
            ...
            <Link
              to="/pdf/6 years placement data 2023-24.pdf"
              target="_blank"
              className="text-[#DC143C] hover:bg-[#DC143C] hover:text-white border-2 border-[#DC143C] rounded text-lg md:text-base xlg:text-lg xl:text-2xl  text-center font-bold py-[1.1vmax] md:w-[50%] sm:w-full px-[1.5vmax]"
            >
