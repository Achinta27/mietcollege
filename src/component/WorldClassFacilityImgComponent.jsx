...
const WorldClassFacilityImgComponent = () => {
  return (
    <div className="md:flex sm:hidden flex-col gap-4 justify-center items-center ">
      ...
      <div className="flex flex-col gap-2 relative sm:mt-[15rem] xl:mt-[16rem] lg:mt-[10rem] w-full items-center ">
